...
import singleItalianPizza from "@/common/images/single-italian-pizza.png";
import circlePlus from "@/common/images/circle-plus.png";
import deliverMan from "@/common/images/delivery-man.png";

interface ItalianPizzasProps {
  singleItem: any;
}

const ItalianPizzas = ({ singleItem }: ItalianPizzasProps) => {
